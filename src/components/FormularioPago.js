    ...
    <>
        ...
        <FormGroup>
            <div className='flexPago'>
                <Label for="nombre" className='tituloFormPago'>NOMBRE</Label>
                <Input type="text" name="nombre" className='inputPago'/>
            </div>
        </FormGroup>
        <FormGroup>
            <div className='flexPago'>
                <Label for="telefono" className='tituloFormPago'>TELÉFONO</Label>
                <Input type="text" name="telefono" className='inputPago'/>
            </div>
        </FormGroup>
        <FormGroup>
            <div className='flexPago'>
                <Label for="exampleEmail" className='tituloFormPago'>EMAIL</Label>
                <Input type="email" name="email" className='inputPago'/>
            </div>
        </FormGroup>
        <FormGroup>
            <div className='flexPago'>
                ...
                <Input type="text" name="numeroTarjeta" className='inputPago'/>
            </div>  
        </FormGroup>
